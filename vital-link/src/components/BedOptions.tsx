...
export default function BedOptions({ bed }: { bed: BedWithPatientData }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-[100vw]! h-screen sm:max-w-[80vw]! sm:h-[90vh] flex flex-col p-4 sm:p-6 sm:overflow-hidden m-0 sm:m-auto rounded-none sm:rounded-xl">
        <DialogHeader className="border-b pb-4 shrink-0 pr-6 sm:pr-8">
          <DialogTitle className="text-xl sm:text-2xl flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
            <span className="font-bold text-slate-900">
              {patient.lastName}, {patient.firstName}
            </span>
            <span
              className={`text-xs sm:text-sm px-2 sm:px-3 py-1 rounded-md font-bold shadow-sm ${
          ...
          <div className="sm:text-sm text-xs text-slate-500 flex flex-col sm:flex-row sm:flex-wrap sm:gap-x-6 gap-y-1 mt-2">
        ...
        <div className="flex-1 overflow-y-auto lg:overflow-hidden mt-4">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-8 h-full">
            <div className="lg:border-r lg:pr-6 lg:overflow-y-auto flex flex-col pb-4">
            ...
            <div className="h-100 lg:h-full flex flex-col bg-slate-50/50 rounded-xl sm:rounded-2xl border border-slate-200 shadow-inner mt-4 lg:mt-0">
              <div className="p-3 sm:p-4 border-b border-slate-200 bg-white shadow-sm z-10 rounded-t-xl sm:rounded-t-2xl">
